...
export function TechnicianServicesScreen() {
    ...
    const [services, setServices] = useState([
        ...
        { id: '3', name: 'Battery Service', enabled: false, icon: 'battery-charging' },
        { id: '4', name: 'Oil Change (on-site)', enabled: true, icon: 'oil' },
        { id: '5', name: 'Computer Diagnostics', enabled: false, icon: 'laptop-car' },
    ]);
        ...
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            ...
            <ScrollView style={styles.content}>
                <View style={[styles.section, { backgroundColor: theme.cardBackground }]}>
                    {services.map((service, index) => (
                        <View
                            ...
                            style={[
                                styles.serviceItem,
                                { borderBottomColor: theme.border, borderBottomWidth: index === services.length - 1 ? 0 : 1 }
                            ]}
                        >
                            <View style={styles.serviceLeft}>
                                <View style={[styles.iconBox, { backgroundColor: service.enabled ? '#F4C43020' : '#F5F5F5' }]}>
                ...
                <TouchableOpacity style={styles.addButton}>
                    ...
                    <Text style={styles.addButtonText}>{t('technician.add_service_type')}</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    );
